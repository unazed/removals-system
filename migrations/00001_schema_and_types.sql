...
-- +goose Down
-- +goose StatementBegin
DROP TABLE types.UserStatus;
DROP TABLE types.UserRoles;
DROP TABLE types.BusinessResourceTypes;
DROP TABLE types.BidActionType;
DROP TABLE types.PhoneNumberTypes;
DROP TABLE types.OrderStaffRoles;
DROP TABLE types.AddressTypes;
DROP TABLE types.BusinessStaffRoles;
DROP TABLE types.ItemCategories;
